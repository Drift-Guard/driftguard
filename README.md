...
**Roadmap:** [docs/ROADMAP.md](docs/ROADMAP.md) — next flagship is **semantic drift detection** (value-level changes that pass schema validation). Live page: [driftguard.org/roadmap](https://driftguard.org/roadmap).
