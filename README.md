...
Optional: set `DRIFTGUARD_API` if you use a custom domain (default: `https://driftguard.dev`).
...
Hosted plans start at **$19/mo**. See [pricing](https://driftguard.dev/pricing).
