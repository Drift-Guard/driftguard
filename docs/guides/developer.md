...
**Before you start:** Node.js 20+, DriftGuard CLI via `npx @drift-guard/driftguard@latest` (or clone + build). See [Getting started — install](../getting-started.md#1-install-the-free-client).
