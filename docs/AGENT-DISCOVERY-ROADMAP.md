# Agent discovery roadmap (moved)

Agent discovery specs, distribution task IDs, and competitive parity analysis are **private product IP**. Maintained in **`driftguard-cloud`** only (`docs/product/AGENT-DISCOVERY-ROADMAP.md`).
