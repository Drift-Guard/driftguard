...
**Pin:** `npx @drift-guard/driftguard@0.3.3` (never `@latest` in production pipelines).
...
|--|----------------|-----------|
| Distribution | Composite actions on Marketplace | `npx @drift-guard/driftguard@X.Y.Z` in `.gitlab-ci.yml` |
