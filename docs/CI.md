...
Offline diff and coverage **preview** work without signup. Continuous monitoring, alerts, and MCP polling require [hosted Pro/Team](https://driftguard.org/pricing).
