...
| **Enhancement opportunities** | Trip↔drift correlation for post-mortems (2B); cache TTL tuning in runbooks |
| **Roadmap / gate refs** | Gate 2A · CP-3.1 · FG-2A-* · [runtime contract preflight](./guides/runtime-contract-preflight.md) · [packages/fuseguard](../packages/fuseguard/README.md) |
| **Assessment** | **TBD** |
...
| **E5** | **Runtime contract preflight (FuseGuard)** | FuseGuard · Hosted preflight | Dim 3 — guardrails before/during action; tool-use validation | **Partial** (CP-3.1 OSS + hosted preflight) | Trip ingest correlation (E14); A2A runtime (E7) | CP-3.1 · [runtime-contract-preflight](./guides/runtime-contract-preflight.md) | OSS + hosted | **[Draft](./assessments/mgfa/E05-runtime-contract-preflight.md)** |
