...
| **Current capabilities** | Scheduled checks, MCP `tools/list` polling, drift events, webhooks, console, semantic drift (Pro/Team), Team audit export (partial) |
| **Enhancement opportunities** | Watch health SLOs; structured audit export; semantic vs structural boundary docs; incident lifecycle for MGFA buyers |
...
| **E4** | **Drift history and audit export** | Hosted DriftGuard | Dim 3 — logging and monitoring; Dim 2 — evidence for oversight audits | **Partial** (Team tier export referenced) | Structured export (CSV/JSON) aligned to watch lifecycle; retention and immutability story for enterprise | Team features · [webhooks-alerts](./reference/webhooks-alerts.md) | Hosted | **[Draft](./assessments/mgfa/E04-drift-history-audit-export.md)** |
...
**Refine before sales claims:** E3 (ToolChange alpha/advisory), E4 (Team export incomplete), E5/E6 (hosted resolution pieces), E9 (literal-only blocking), E13 (semantic boundary / compliance claim risk), E17/E18 (replay + fixture **content** more than code).
...
|-------|-------|
| **Created** | 2026-06 |
| **Last expanded** | 2026-06 — full ecosystem portfolio (gate packages, harness, evaluator, hosted complements) |
